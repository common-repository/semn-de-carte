<?php
/*
Plugin Name: Semn De Carte
Version: 1.1
Plugin URI: -
Author: noob
Author URI: -
Description: Semn De Carte - Adds the social bookmarks icons to blog articles. It is special designed for romanian networks. 

    Copyright 2011 noob(Email: slackwave@gmail.com)
...
class social_bookmarks
{
	...
	function social_bookmarks()
	{
		...
		// Default Settings
		$this->default_settings = array('dw_sites' => 'blogro|reddit|delicious|digg|technorati|stumbleupon|google|facebook|myspace|twitter|diggro|cica|ask',		
							'dw_label' => ' ',
							'dw_target' => 'new',
	...
	{
		print("<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"".$this->plugin_dir."semn_de_carte.css\" />\n");
	}
